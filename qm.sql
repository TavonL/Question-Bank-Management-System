...
CREATE TABLE `little_question` (
  ...
  `little_question_content` MEDIUMTEXT DEFAULT NULL,
  `little_question_answer` MEDIUMTEXT DEFAULT NULL,
  `little_question_analy` MEDIUMTEXT DEFAULT NULL,
...
CREATE TABLE `question` (
  ...
  `question_content` MEDIUMTEXT DEFAULT NULL,
  `question_answer` MEDIUMTEXT DEFAULT NULL,
  `question_analy` MEDIUMTEXT DEFAULT NULL,
